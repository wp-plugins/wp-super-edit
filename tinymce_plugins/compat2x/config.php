...
$wp_super_edit->register_tinymce_plugin( array(
	'name' => 'compat2x', 
	'nicename' => 'TinyMCE 2.x Compatiblity', 
	'description' => 'This plugin attempts to offer compatibility with old TinyMCE 2.x plugins. Please suggest to the author to upgrade development to TinyMCE 3.x', 
