...
tinyMCE.importPluginLanguagePack('supertable');
...
var TinyMCE_TablePlugin = {
	...
	getControlHTML : function(control_name) {
		var controls = new Array(
			['supertable', 'table.gif', 'lang_table_desc', 'mceInsertTable', true],
		...
		if (control_name == "supertablecontrols") {
			var html = "";
		...
		switch (command) {
			case "mceTableRowProps":
				...
				if (user_interface) {
					...
					template['file'] = this.baseURL + '/row.htm';
					template['width'] = 380;
					template['height'] = 295;
			...
			case "mceTableCellProps":
				...
				if (user_interface) {
					...
					template['file'] = this.baseURL + '/cell.htm';
					template['width'] = 380;
					template['height'] = 295;
			...
			case "mceInsertTable":
				if (user_interface) {
					...
					template['file'] = this.baseURL + '/table.htm';
					template['width'] = 380;
					template['height'] = 295;
					...
					case "mceTableMergeCells":
						...
						if (tinyMCE.isMSIE || sel.rangeCount == 1) {
							if (user_interface) {
								...
								template['file'] = this.baseURL + '/merge_cells.htm';
								template['width'] = 250;
...
tinyMCE.addPlugin("supertable", TinyMCE_TablePlugin);
